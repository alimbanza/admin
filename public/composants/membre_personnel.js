        ...
        return (
            <div className="col-md-12">
                <div className="row mt-4">
                    ...
                    <Devise taille_devise="col-md-4" tail="col-sm-8" change={this.props.change} />
                    <div className="col-md-2">
            ...
            .done((response)=>{
                if(response.reponse=='r'){
                    ...
                    if(response.reponse =='deconnexion'){
                        window.location.replace("http://54.167.118.145:8001/")
                    }else{
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body" id="modal_user">
                            <div className="row">
                                <span className="photo media-left"><img style={stylePhotoProfil} id="photo" alt="avatar" src={this.props.photo} /></span>
                            </div><br/>
                            <div className="row">
                ...
                <div className="col-12">
                    <div className="card form-card" style={stylefrom}>
                        <div className="card-body" >
                            ...
                            <Detail_utilisateur photo={this.state.photo} email={this.state.email} adresse_physique={this.state.adresse_physique} lieu_naissance={this.state.lieu_naiss} date_naissance={this.state.date_naissance} structure={this.state.structure} />
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    {(this.state.compte !='') ?  <tr><td className="col-1">Denomination</td><td>: {denomination}</td><td>Autorisation</td><td>: <a href={'http://54.167.118.145:8001/'+autorisation} target="blank">Document administratif</a> </td></tr> :'' }
                                    {(this.state.compte !='') ?  <tr><td className="col-1">Email</td><td>: {email}</td><td>Adresse Physique</td><td>: {adresse_physique}</td></tr> :'' }
                                    ...
                                    {(this.state.compte !='') ?  <tr><td className="col-1"><img style={styleimg} src={'http://54.167.118.145:8001/'+photo} className="rounded-circle" /></td><td></td>
                                            <td colspan="2">
        ...
        return (
            <div className="col-12" style={divStyle}>
                <div className="card form-card" style={stylefrom}><br/>
                    <Msg bol={ (this.state.state_msg=='r') ? <Msg_reussite msg_reu="Monnaie enregistrée avec succès." /> : (this.state.state_msg=='e') ? <Msg_erreur msg_err={this.state.erreur}/> : ''} />
                    <hr/>
                    <div className="card-body">
                        <div className="row">
                            <div className="col-md-6">
...
class Repertoire_agence extends React.Component {
    ...
    async modifier(event) {
        ...
        if(res =='deconnexion' || solde.result =='deconnexion')  window.location.replace("http://54.167.118.145:8001/")
    ...
    render() {
        let res = this.props.rep_ag,
            listAgence = res.map(item => (
                <Tableau_agence numero={item.id} denomination={item.denomination} telephone={item.telephone} commune={item.numero_parcel} rue={item.avenue} quartier={item.quartier} action={<Action_agence data_id={item.id} clc={this.modifier} style={blockbtn} target="#exampleModal4" />}/>
            ))
        return (
            <div className="col-12" style={divStyle}>
                <div className="col-12">
...
class Config_transaction extends React.Component {
    ...
    async modifier(event) {
        ...
        if(res =='deconnexion') window.location.replace("http://54.167.118.145:8001/")
        res.map(item => (
            this.setState({
                min      :item.minimum,
                max      :item.maximum,
    ...
    async update(event) {
        ...
        if(update_transaction.result =='r'){
            ...
            if(update_transaction.result =='deconnexion'){
                window.location.replace("http://54.167.118.145:8081/")
            }else{
    ...
    async rechercher(event) {
        ...
        if(rep.result =='deconnexion')  window.location.replace("http://54.167.118.145:8001/")
...
class Depot_usd extends React.Component {
    ...
    async send(event) {
        ...
        if(send_compte.result =='deconnexion') window.location.replace("http://54.167.118.145:8001/")
...
class Configuration_generaux extends React.Component {
    ...
    async send(event) {
        ...
        if(send.result =='deconnexion') window.location.replace("http://54.167.118.145:8001/")
        if(send.result =='r'){
            this.setState({
...
class Wallet_don extends React.Component {
    ...
    async send_wallet_don(event) {
        ...
        if(response2.result =='deconnexion') window.location.replace("http://54.167.118.145:8001/")
...
class Wallet_don_paiement extends React.Component {
    ...
    async send_wallet_don(event) {
        ...
        let data = { id :'' },
            ...
            if(wallet_don.result =='deconnexion')  window.location.replace("http://54.167.118.145:8001/")
    ...
    render() {
        ...
        return (
            <div className="col-12" style={divStyle}>
                 <div className="card form-card" style={stylefrom}>
                    <Msg bol={ (this.state.state_msg=='r') ? <Msg_reussite msg_reu="Paiement enregistré avec succès." /> : (this.state.state_msg=='e') ? <Msg_erreur msg_err={this.state.erreur}/> : ''} />
                        <div className="card-body">
                            <form method="post" onSubmit={this.send_wallet_don}>
                                <hr/>
                                <div className="row">
...
rep_compte.addEventListener('click',async (e)=>{
    ...
    if(res_type_piece =='deconnexion') window.location.replace("http://54.167.118.145:8001/")
...
membre.addEventListener('click',async(e)=>{
    ...
    if(res_membre.result =='deconnexion')  window.location.replace("http://54.167.118.145:8001/")
...
rep_partenaire.addEventListener('click',async (e)=>{
    ...
    let dataPertenaire = {
        ...
        res = response_rep_part.reponse
    if(response_rep_part.result =='deconnexion') window.location.replace("http://54.167.118.145:8001/")
    let root = ReactDOM.createRoot(document.querySelector('.corps'));
